      ...
      <View style={{
        ...
        borderColor: "#FFEF78",
          ...
          <View style={{flexDirection: "row"}}>
            <Text style={{ fontSize: 20, color: '#EB9200', fontWeight: 'bold' }}>{item.nome}x </Text>
            <Text style={{ fontSize: 20, color: '#EB9200', fontWeight: 'bold' }}>{item.quantidade}</Text>
          </View>
    ...
    <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center", backgroundColor: '#FFEF78'}}>
      ...
      <View style={{alignItems: 'center', marginTop: 20, marginBottom: 20}}>
        <TouchableOpacity style={{
            ...
            >
            <Fontisto name='shopping-basket-add' size={30} style={{color: "#3756de"}} />
          </TouchableOpacity>
      </View>
    </View>
