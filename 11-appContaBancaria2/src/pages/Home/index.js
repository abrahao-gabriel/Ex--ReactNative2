...
import { View, Text, Button, TextInput, ScrollView, Switch, Pressable } from 'react-native';
        ...
        <Picker
         ...
         <Text style={styles.texto}>Limite: </Text>
          <Slider
            ...
            minimumTrackTintColor='#671687'
            maximumTrackTintColor='navy'
            thumbTintColor='#671687'
          />
